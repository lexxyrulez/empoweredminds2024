  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 pt-4 pt-lg-0 content">
        ...
        <h3>Empowering Minds Through Tailored Support</h3>
        <p class="fst-italic">
          At Empowered Minds, we are dedicated to providing personalized services that nurture potential, build confidence, and enable success for individuals from all walks of life.
        </p>
      
        <div class="skills-content skills-animation">
      
          <div class="progress">
            <span class="skill"><span>Special Needs Education</span> <i class="val">100%</i></span>
          ...
          <div class="progress">
            <span class="skill"><span>Exam Preparation and Strategy</span> <i class="val">90%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill"><span>In-School Mentorship and Guidance</span> <i class="val">75%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill"><span>Language Development Sessions</span> <i class="val">55%</i></span>
            <div class="progress-bar-wrap">
