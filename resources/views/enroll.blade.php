...
<section id="enroll-coming-soon" class="section" style="padding: 30px; background-color: #f9f9f9;">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="text-center mb-4">
            <h2 style="color: #d57176;">Enroll System Coming Soon</h2>
            <p>We’re excited to announce that our enrollment system is coming soon! Stay informed by providing your details below.</p>
        </div>
...
<div class="form-step" id="step-1">
    ...
    <div class="mb-3">
        <label for="birth-certificate" class="form-label">Upload Birth Certificate/Identification</label>
        <input type="file" name="birth_certificate" id="birth-certificate" class="form-control" required>
    </div>
    <div class="mb-3">
...
<div class="form-step" id="step-2" style="display: none;">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="parent2_relationship" id="parent2-relationship" class="form-control">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="parent2_occupation" id="parent2-occupation" class="form-control">
    </div>
    <div class="mb-3">
...
<div class="form-step" id="step-3" style="display: none;">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="prev_school_address" id="prev-school-address" class="form-control">
    </div>
    <div class="mb-3">
    ...
    <!-- Student Records -->
    <div class="mb-3">
        <label for="school-records" class="form-label">Upload Copies of Previous School Records</label>
        <input type="file" name="school_records[]" id="school-records" class="form-control" multiple>
    </div>

    <!-- Special Needs Information -->
    <h3>Health and Special Needs</h3>
    <div class="mb-3">
        <label for="learning-difficulties" class="form-label">Does the student have any learning difficulties or special needs?</label>
        <div>
            <input type="radio" name="learning_difficulties" value="Yes" id="learning-difficulties-yes">
            <label for="learning-difficulties-yes">Yes</label>
        </div>
        <div>
            <input type="radio" name="learning_difficulties" value="No" id="learning-difficulties-no">
            <label for="learning-difficulties-no">No</label>
        </div>
        <div class="mt-2">
            <label for="learning-difficulties-details" class="form-label">If yes, provide details and upload supporting documentation:</label>
            <textarea name="learning_difficulties_details" id="learning-difficulties-details" class="form-control"></textarea>
            <input type="file" name="learning_difficulties_file" id="learning-difficulties-file" class="form-control mt-2">
        </div>
    </div>

    <!-- Medical Conditions -->
    <div class="mb-3">
        <label for="medical-conditions" class="form-label">Does the student have any medical conditions or allergies?</label>
        <div>
            <input type="radio" name="medical_conditions" value="Yes" id="medical-conditions-yes">
            <label for="medical-conditions-yes">Yes</label>
        </div>
        <div>
            <input type="radio" name="medical_conditions" value="No" id="medical-conditions-no">
            <label for="medical-conditions-no">No</label>
        </div>
        <div class="mt-2">
            <label for="medical-conditions-details" class="form-label">If yes, provide details:</label>
    ...
    <!-- Regular Medication -->
    <div class="mb-3">
        <label for="regular-medication" class="form-label">Is your child on any regular medication?</label>
        <div>
            <input type="radio" name="regular_medication" value="Yes" id="regular-medication-yes">
            <label for="regular-medication-yes">Yes</label>
        </div>
        <div>
            <input type="radio" name="regular_medication" value="No" id="regular-medication-no">
            <label for="regular-medication-no">No</label>
        </div>
        <div class="mt-2">
            <label for="regular-medication-details" class="form-label">If yes, specify the medication and dosage:</label>
    ...
    <!-- Immunization Record -->
    <div class="mb-3">
        <label for="immunizations" class="form-label">Has your child received all recommended immunizations?</label>
        <div>
        ...
        <div class="mt-2">
            ...
            <label for="immunization-file" class="form-label mt-2">Attach a copy of your child’s immunization record:</label>
            <input type="file" name="immunization_file" id="immunization-file" class="form-control">
        </div>
    </div>
    ...
    <h3>Permissions</h3>
    <div class="mb-3">
        <label for="first-aid" class="form-label">I authorize the center to administer basic first aid to my child in case of minor injuries</label>
        <div>
    ...
    <div class="mb-3">
        <label for="emergency-medical" class="form-label">In case of an emergency, I authorize the center to seek medical attention for my child if I cannot be reached</label>
        <div>
            <input type="radio" name="emergency_medical" value="Yes" id="emergency-medical-yes">
...
<div class="form-step" id="step-4" style="display: none;">
    ...
    <!-- Program Information -->
    <div class="mb-3">
        <label for="curriculum" class="form-label">Which curriculum would you prefer for your child?</label>
    ...
    <div class="mb-3">
        <label for="academic-focus" class="form-label">Are there specific areas of academic focus or goals for the student?</label>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="emergency_contact_name" id="emergency-contact-name" class="form-control" required>
    </div>
    <div class="mb-3">
        <label for="emergency-relationship" class="form-label">Relationship to Student</label>
        <input type="text" name="emergency_relationship" id="emergency-relationship" class="form-control" required>
    </div>
    <div class="mb-3">
        <label for="emergency-phone" class="form-label">Phone Number</label>
        <input type="text" name="emergency_phone" id="emergency-phone" class="form-control" required>
    </div>

    <!-- Declaration -->
    <h3>Declaration</h3>
    <p>
        I, the undersigned, hereby declare that the information provided in this application is true and complete to the best of my knowledge. I understand that providing false or incomplete information may result in the rejection of this application or termination of enrollment.
    </p>
    <div class="mb-3">
        <label for="declaration-name" class="form-label">Parent/Guardian Name</label>
        <input type="text" name="declaration_name" id="declaration-name" class="form-control" required>
    </div>
